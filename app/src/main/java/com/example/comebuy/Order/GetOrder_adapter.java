...
public class GetOrder_adapter extends ArrayAdapter<GetOrder> {
    private int resourceId;
    View view;
    ViewHolder viewHolder;
    public GetOrder_adapter(@NonNull Context context, int resourceId, @NonNull List<GetOrder> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        GetOrder allOrder = getItem(position);
        if (convertView == null){
